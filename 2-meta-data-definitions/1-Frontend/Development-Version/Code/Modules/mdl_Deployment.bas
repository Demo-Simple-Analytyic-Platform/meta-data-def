Attribute VB_Name = "mdl_Deployment"
...
Public Sub run_powershell_to_deploy_metadata_defintitions()
    ...
    Dim cmd As String: cmd = "cmd.exe /c powershell -ExecutionPolicy Bypass -File """ & fp_script & """"
    '
    ' Start Wait file
    ...
    shell.Run cmd, 1, False  ' 1 = show window, False = do not wait for completion
