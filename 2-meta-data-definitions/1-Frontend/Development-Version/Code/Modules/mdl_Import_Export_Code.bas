...
Public Sub ImportAll() 'As Boolean
    '
    ' Set Folder paths
    Call set_folder_paths
    '
...
ErrHandle:
    ...
    log.WriteLine "Number      : " & Err.Number
    log.WriteLine "Line        : " & Err.line
    log.WriteLine "Source      : " & Err.Source
    log.WriteLine "HelpContext : " & Err.HelpContext
    log.WriteLine ""
    Stop
    Resume Next
    '
